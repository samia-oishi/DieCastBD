    ...
    <section className={className}>
      <Container>
        ...
        <div
          ...
          {...dragProps}
          data-carousel
          className="-mx-4 mt-3 flex snap-x snap-proximity gap-3 overflow-x-auto px-4 pb-1 pt-3 [scrollbar-width:none] md:mx-0 md:mt-3.5 md:gap-5 md:px-0 md:pb-3 [&::-webkit-scrollbar]:hidden"
        >
          {isLoading
