...
export const BD_DISTRICTS = [
  ...
  { name: "Barisal", division: "Barisal", aka: ["Barishal"], sf: "Barishal", thanas: [{"n":"Agailjhara"},{"n":"Babuganj"},{"n":"Bakerganj"},{"n":"Banaripara"},{"n":"Barishal Sadar","a":["Barisal Sadar"]},{"n":"Charkaua"},{"n":"Goriarpar"},{"n":"Gouronadi","a":["Gournadi"]},{"n":"Hizla"},{"n":"Mehendiganj"},{"n":"Muladi"},{"n":"Natun Bazar"},{"n":"Wazirpur"}] },
  ...
  { name: "Bogura", division: "Rajshahi", aka: ["Bogra"], sf: "Bogra", thanas: [{"n":"Alamdighi","a":["Adamdighi"]},{"n":"Baropur (Bogura)"},{"n":"Bogura Sadar"},{"n":"Dhunat","a":["Dhunot"]},{"n":"Dhupchancia","a":["Dupchanchia"]},{"n":"Gabtoli","a":["Gabtali"]},{"n":"Kahaloo"},{"n":"Nandigram","a":["Nondigram"]},{"n":"Saraikandi"},{"n":"Shajahanpur"},{"n":"Sherpur"},{"n":"Shibganj"},{"n":"Sonatola","a":["Sonatala"]}] },
  ...
  { name: "Dhaka", division: "Dhaka", sf: "Dhaka City", thanas: [{"n":"Adabor"},{"n":"Airport"},{"n":"Ashulia","s":"Dhaka Sub-Urban"},{"n":"Ati Bazar (Keraniganj)"},{"n":"Azompur"},{"n":"Badda"},{"n":"Banani"},{"n":"Bangshal"},{"n":"Bashundhara R/A"},{"n":"Battery Section"},{"n":"Bhashantek"},{"n":"Cantonment"},{"n":"Chalkbazar","a":["Chawkbazar"]},{"n":"Dakshin khan","a":["Dakshinkhan"]},{"n":"Darus Salam"},{"n":"Demra"},{"n":"Dhamrai","s":"Dhaka Sub-Urban"},{"n":"Dhanmondi"},{"n":"Dohar","s":"Dhaka Sub-Urban"},{"n":"Gandaria"},{"n":"Gulistan"},{"n":"Gulshan"},{"n":"Hatirjheel"},{"n":"Hazaribag","a":["Hazaribagh"]},{"n":"Hemayetpur","s":"Dhaka Sub-Urban"},{"n":"Jattrabari","a":["Jatrabari"]},{"n":"Kadamtali","a":["Kadamtoli"]},{"n":"Kafrul"},{"n":"Kalabagan"},{"n":"Kamrangirchar"},{"n":"Keraniganj Model","s":"Dhaka Sub-Urban","a":["Keraniganj"]},{"n":"Khilgaon"},{"n":"Khilkhet"},{"n":"Kotwali"},{"n":"Lalbagh"},{"n":"Mirpur","a":["Mirpur Model"]},{"n":"Mohammadpur"},{"n":"Motijheel"},{"n":"Mugda"},{"n":"Nawabganj","s":"Dhaka Sub-Urban"},{"n":"New Market"},{"n":"Pallabi"},{"n":"Paltan","a":["Paltan Model"]},{"n":"Panthapath"},{"n":"Purbachal"},{"n":"Ramna","a":["Ramna Model"]},{"n":"Rampura"},{"n":"Rupnagar"},{"n":"Sabujbag","a":["Sabujbagh"]},{"n":"Savar","s":"Dhaka Sub-Urban"},{"n":"Shah Ali"},{"n":"Shah Ali Market"},{"n":"Shahbag","a":["Shahbagh"]},{"n":"Shahjahanpur"},{"n":"Sher-e-Bangla Nagar"},{"n":"Shyampur"},{"n":"South Keraniganj","s":"Dhaka Sub-Urban"},{"n":"Sutrapur"},{"n":"Tejgaon"},{"n":"Tejgaon Industrial Area"},{"n":"Turag"},{"n":"Uttara","a":["Uttara East","Uttara West"]},{"n":"Uttarkhan"},{"n":"Vasantek"},{"n":"Vatara"},{"n":"Wari"}] },
  ...
  { name: "Jhalakathi", division: "Barisal", aka: ["Jhalokati"], sf: "Jhalokati", thanas: [{"n":"Jhalokati sadar","a":["Jhalakathi Sadar"]},{"n":"Kathalia"},{"n":"Nalchity"},{"n":"Rajapur"}] },
  ...
  { name: "Khagrachhari", division: "Chattogram", aka: ["Khagrachori"], sf: "Khagrachori", thanas: [{"n":"Dighinala"},{"n":"Guimara"},{"n":"khagrachari sadar","a":["Khagrachhari Sadar"]},{"n":"Laxmichari","a":["Laxmichhari"]},{"n":"Mahalchari","a":["Mohalchari"]},{"n":"Manikchhari","a":["Manikchari"]},{"n":"Matiranga"},{"n":"Panchari"},{"n":"Ramgarh"}] },
  ...
  { name: "Kushtia", division: "Khulna", aka: ["Kustia"], sf: "Kustia", thanas: [{"n":"Bheramara"},{"n":"Bittipara EB"},{"n":"Daulatpur"},{"n":"Khoksa"},{"n":"Kumarkhali"},{"n":"Kushtia Sadar"},{"n":"Mirpur upazila","a":["Mirpur"]}] },
  { name: "Lakshmipur", division: "Chattogram", aka: ["Laxmipur"], sf: "Laxmipur", thanas: [{"n":"Banchanagar (Laxmipur)"},{"n":"Chandraganj"},{"n":"Kamalnagar"},{"n":"Laxmipur Sadar"},{"n":"Raipur"},{"n":"Ramganj"},{"n":"Ramgati"}] },
  ...
  { name: "Narsingdi", division: "Dhaka", aka: ["Narshindi"], sf: "Narshindi", thanas: [{"n":"Belabo"},{"n":"Ghorashal"},{"n":"Madhobdi"},{"n":"Monohardi"},{"n":"Narsingdi Sadar"},{"n":"Palash"},{"n":"Raipura"},{"n":"Shibpur"}] },
  ...
  { name: "Panchagarh", division: "Rangpur", aka: ["Panchgarh"], sf: "Panchgarh", thanas: [{"n":"Atwari"},{"n":"Boda"},{"n":"Debiganj"},{"n":"Panchgarh sadar Thana","a":["Panchagarh Sadar"]},{"n":"Tetulia"}] },
  ...
  { name: "Satkhira", division: "Khulna", aka: ["Shatkhira"], sf: "Shatkhira", thanas: [{"n":"Assasuni"},{"n":"Debhata"},{"n":"Kalaroa"},{"n":"Kaliganj"},{"n":"Patkelghata"},{"n":"Shatkhira sadar","a":["Satkhira Sadar"]},{"n":"Shyamnagar"},{"n":"Tala"}] },
