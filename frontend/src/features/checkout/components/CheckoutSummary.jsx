...
function OrderItem({ item }) {
  ...
  return (
    <div className="flex items-center gap-3">
      <div className="relative flex size-[52px] shrink-0 items-center justify-center overflow-hidden rounded-[10px] bg-tile md:size-14">
        {product.thumbnail?.url && <img src={cloudinaryCard(product.thumbnail.url)} alt="" className="h-full w-auto max-w-none" />}
      </div>
