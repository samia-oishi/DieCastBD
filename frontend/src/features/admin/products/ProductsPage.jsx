          ...
          {products.map((p) => {
            ...
            return (
              <div
                key={p._id}
                className={cn(
                  "relative grid grid-cols-[auto_minmax(0,1fr)] items-center gap-3 border-b border-line-soft px-4 py-3.5 transition-colors last:border-b-0 hover:bg-[#FCFCF9] md:px-5 md:py-[13px]",
                  GRID,
                  isSel && "bg-[#FBFDF3]"
                )}
              >
