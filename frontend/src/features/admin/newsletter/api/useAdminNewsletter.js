...
import { listAdminSubscribers, listAdminAudience, deleteAdminSubscriber } from "./newsletterApi";
...
export function useAdminAudience(params) {
  return useQuery({
    queryKey: ["admin", "newsletter", "audience", params],
    queryFn: () => listAdminAudience(params),
    placeholderData: (previous) => previous,
  });
}
